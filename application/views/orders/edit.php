          ...
          <form role="form" action="<?php base_url('Controller_Orders/create') ?>" method="post" class="form-horizontal">
              <div class="box-body">
                         ...
                         <td>
                          <select class="form-control select_group product" data-row-id="row_<?php echo $x; ?>" id="product_<?php echo $x; ?>" name="product[]" style="width:100%;" onchange="getProductData(<?php echo $x; ?>)" required>
                              ...
                              <?php foreach ($products as $k => $v): ?>
                                <option value="<?php echo $v['id'] ?>" <?php if($val['product_id'] == $v['id']) { echo "selected='selected'"; } ?>><?php echo $v['name'].'-['.$v['sku'] .']'  ?></option>
                              <?php endforeach ?>
                            </select>
                          </td>
                ...
                <div class="col-md-6 col-xs-12 pull pull-left">
                  ...
                  <div class="form-group">
                    <label for="paid_status" class="col-sm-5 control-label">Statut de paiement</label>
                    <div class="col-sm-7">
              ...
              <div class="box-footer">
                ...
                <a target="__blank" href="<?php echo base_url() . 'Controller_Orders/printDiv/'.$order_data['order']['id'] ?>" class="btn btn-default" >Imprimer</a>
