...
class Model_orders extends CI_Model
{
	...
	public function create()
	{
		...
		$idPersonalMIX = $this->input->post('customer_name');
		$idPersonalSprlit=explode("|",$idPersonalMIX);
		$idPersonal=$idPersonalSprlit[0];
		$clientData=$this->getEmployeeData($idPersonal);
		$clientName=$clientData['prenom'] . " " .$clientData['nom'];
		$creditClient=$clientData['Credit'];
		$creditRest=$creditClient-$this->input->post('net_amount_value');
		$this->updateEmployeeCredit($idPersonal,$creditRest);
	...
	public function updateEmployeeCredit($id, $montantRest){
